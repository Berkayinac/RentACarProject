...
// rol bazlý implement için -> ISecuredRequest implement edilir.
public class CreateFuelCommand : IRequest<CreatedFuelResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    // features içerisindeki operation claimler veya admin veya write yetkilerine sahip olan kiþiler bu iþlemi yapabilmesini saðlar.
    // giriþ yapýldýðýnda yetki varsa bu iþlemi kullanabiliriz.
