...
public class BrandsController : BaseController
{
    ...
    {
        //Mediator -> .NET kütüphanesi
        // Mediator design pattern'i implemente ederek komutlarý nasýl iþleyeceðini belirler.

        //  Mediator gönderilen command'in handler'ýný bularak iþlemi ypar
        // her bir command'in sadece tek bir handler'ý olacaðýndan mediator otomatik tespit ederek iþlemi gerçekleþtiriyor.
